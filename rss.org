...
#+name: macro-post-content
#+begin_src shell :results verbatim
sed -n '/<div id="content" class="container">/,/<div id="postamble" class="status">/p' emacs-macro-for-classes-to-records/index.html | head -n-1 | sed 's/</\&lt;/g' | sed 's/>/\&gt;/g'
#+end_src

#+RESULTS: macro-post-content
#+begin_example
...
&lt;li&gt;Select the whole class again by moving one line down &lt;code&gt;j&lt;/code&gt; and then pressing &lt;code&gt;V %&lt;/code&gt;&lt;/li&gt;
...
&lt;li&gt;Select the whole class again by pressing &lt;code&gt;V %&lt;/code&gt;&lt;/li&gt;
...
&lt;li&gt;Move to the beginning of the class &lt;code&gt;A&lt;/code&gt; to get to the end of the line &lt;code&gt;%&lt;/code&gt; to jump to the opening curly boi&lt;/li&gt;

&lt;li&gt;&lt;code&gt;A&lt;/code&gt; to edit at the end of the line, then backspace twice to delete the curly boi and newline, replace it with &lt;code&gt;(&lt;/code&gt;,
&lt;code&gt;esc&lt;/code&gt; to go back to normal mode after typing.&lt;/li&gt;

&lt;li&gt;This change breaks the scope declaration so &lt;code&gt;%&lt;/code&gt; won't work for getting to the end of the block anymore,
...
back to normal mode.&lt;/li&gt;

&lt;li&gt;Finally &lt;code&gt;C-x )&lt;/code&gt; to finish recording the macro.&lt;/li&gt;
&lt;/ul&gt;
